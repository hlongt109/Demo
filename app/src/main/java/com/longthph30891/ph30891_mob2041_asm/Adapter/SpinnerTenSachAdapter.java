...
public class SpinnerTenSachAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<Sach> list;

    public SpinnerTenSachAdapter(Context context, ArrayList<Sach> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvMa.setText(list.get(position).getMaTheLoai()+".");
        TextView tvName = convertView.findViewById(R.id.tv_name_sp);
        tvName.setText(list.get(position).getTenSach());
        return convertView;
    }
}
